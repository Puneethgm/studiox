...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#09070F] font-sans text-gray-100 selection:bg-violet-500/30 selection:text-violet-200">
      
      {/* Background Glows */}
      <div className="absolute top-0 left-1/4 -z-10 h-[600px] w-[600px] rounded-full bg-violet-900/15 blur-[120px] pointer-events-none" />
      <div className="absolute top-[800px] right-1/4 -z-10 h-[600px] w-[600px] rounded-full bg-indigo-900/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[400px] left-1/3 -z-10 h-[700px] w-[700px] rounded-full bg-fuchsia-950/10 blur-[150px] pointer-events-none" />

      {/* ── Navigation ──────────────────────────────── */}
      <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#09070F]/70 backdrop-blur-xl">
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2.5">
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/20">
              <Sparkles className="h-4 w-4" />
            </div>
            <span className="text-lg font-black tracking-tight text-white bg-gradient-to-r from-white via-white to-gray-400 bg-clip-text text-transparent">1herosocial.ai</span>
          </div>

          <nav className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-medium text-gray-400 hover:text-violet-400 transition-colors">Features</a>
            <a href="#simulator" className="text-sm font-medium text-gray-400 hover:text-violet-400 transition-colors">Lead Simulator</a>
            <a href="#calculator" className="text-sm font-medium text-gray-400 hover:text-violet-400 transition-colors">ROI Calculator</a>
            <Link href="/pricing" className="text-sm font-medium text-gray-400 hover:text-violet-400 transition-colors">Pricing</Link>
          </nav>

          <div className="flex items-center gap-4">
            <Link href="/login" className="text-sm font-medium text-gray-300 hover:text-violet-400 transition-colors">
              Log in
            </Link>
            <Link href="/pricing">
              <button className="flex items-center gap-2 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all shadow-lg shadow-violet-600/30 hover:shadow-violet-600/50 hover:scale-[1.02] active:scale-[0.98]">
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/30 text-violet-300 text-xs font-semibold px-4 py-1.5 rounded-full mb-8 backdrop-blur-sm shadow-inner">
          ...
          <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-white max-w-4xl mx-auto leading-[1.1]">
            One Command Center.
            <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-indigo-400">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/pricing">
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white px-8 py-4 rounded-xl text-base font-bold transition-all shadow-xl shadow-violet-600/30 hover:shadow-violet-600/50 hover:-translate-y-0.5 active:translate-y-0">
                Start Free Trial <ArrowRight className="h-4 w-4" />
              </button>
            </Link>
            <a href="#simulator" className="flex items-center gap-2 text-sm font-semibold text-violet-400 hover:text-violet-300 transition-colors">
              Watch Live Simulator <ArrowRight className="h-3.5 w-3.5" />
            </a>
          </div>

          {/* Social Proof Badges */}
          <div className="mt-14 flex flex-wrap items-center justify-center gap-8 text-sm text-gray-400 font-medium">
      ...
      <section id="simulator" className="mx-auto max-w-6xl px-6 lg:px-8 pb-28">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-white tracking-tight">Real-Time Lead & AI Activity</h2>
          <p className="mt-2 text-gray-400 max-w-xl mx-auto">Watch how incoming queries across social platforms are automatically processed by our AI pipeline.</p>
        </div>

        <div className="bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl relative">
          <div className="absolute top-4 right-4 flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs px-2.5 py-1 rounded-full">
          ...
          <div className="flex items-center gap-2 mb-6 border-b border-white/5 pb-4">
            ...
            <h3 className="font-bold text-white text-lg">Central Lead Stream</h3>
          </div>
          ...
          <div className="space-y-4">
            {simulatedLeads.map((lead) => (
              <div 
                key={lead.id} 
                className="bg-white/[0.03] border border-white/5 rounded-xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all hover:bg-white/[0.05] hover:border-white/10"
              >
                <div className="flex items-start gap-4">
                  <div className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold text-white shadow-inner bg-gradient-to-br ${
                  ...
                  <div>
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className={`text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full ${
                        lead.source === 'Instagram' ? 'bg-purple-500/15 text-purple-300' :
                        lead.source === 'Facebook' ? 'bg-blue-500/15 text-blue-300' :
                        lead.source === 'TikTok' ? 'bg-cyan-500/15 text-cyan-300' :
                        'bg-emerald-500/15 text-emerald-300'
                      }`}>{lead.source}</span>
                    </div>
                    <p className="text-sm text-gray-300 mt-1 italic">"{lead.message}"</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 self-end md:self-center">
                  <span className={`text-xs font-semibold px-3 py-1.5 rounded-lg ${
                    ...
                    lead.status === 'AI Responding' ? 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/20 animate-pulse' :
                    lead.status === 'Trial Booked' ? 'bg-purple-500/10 text-purple-400 border border-purple-500/20' :
      ...
      <section id="calculator" className="mx-auto max-w-6xl px-6 lg:px-8 pb-28">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-white tracking-tight">Interactive Pipeline ROI Calculator</h2>
          <p className="mt-2 text-gray-400 max-w-xl mx-auto">Adjust the sliders to estimate how much revenue your studios can recover by optimizing lead conversions.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          {/* Controls */}
          <div className="lg:col-span-2 bg-white/[0.02] border border-white/10 rounded-2xl p-6 flex flex-col justify-between gap-6">
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-sm font-semibold text-gray-300">Monthly Ad Spend (Paid Social)</label>
                <span className="text-violet-400 font-bold">${adSpend.toLocaleString()}</span>
              </div>
              <input 
                type="range" 
                min="500" 
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-sm font-semibold text-gray-300">Lead-to-Member Conversion Rate</label>
                <span className="text-fuchsia-400 font-bold">{conversionRate}%</span>
              </div>
              <input 
                type="range" 
                min="2" 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-semibold text-gray-400 block mb-1.5">Avg Membership Fee (Monthly)</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/[0.04] border border-white/10 rounded-xl py-2 pl-7 pr-3 text-sm text-white focus:outline-none focus:border-violet-500"
                  />
                </div>
              </div>

              <div>
                <label className="text-xs font-semibold text-gray-400 block mb-1.5">Avg Member Retention (Months)</label>
                <div className="relative">
                  <input 
                    type="number"
                    value={memberLifetimeMonths}
                    onChange={(e) => setMemberLifetimeMonths(Math.max(1, Number(e.target.value)))}
                    className="w-full bg-white/[0.04] border border-white/10 rounded-xl py-2 px-3 text-sm text-white focus:outline-none focus:border-violet-500"
                  />
                </div>
              </div>
            </div>
          ...
          {/* Results Card */}
          <div className="bg-gradient-to-br from-violet-900/40 via-indigo-950/30 to-[#0F0C29]/40 border border-violet-500/20 rounded-2xl p-6 flex flex-col justify-between shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 -translate-y-4 translate-x-4 h-24 w-24 rounded-full bg-violet-500/10 blur-xl pointer-events-none" />
            
            <div>
              <span className="text-[10px] uppercase font-extrabold tracking-wider bg-violet-500/20 text-violet-300 px-2.5 py-1 rounded-full border border-violet-500/30">
                Pipeline Forecast
              </span>
              
              <div className="mt-6 space-y-4">
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-sm text-gray-400">Predicted Leads</span>
                  <span className="font-bold text-white">{leadsGenerated}</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-sm text-gray-400">New Members Won</span>
                  <span className="font-bold text-white">{memberConversions}</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-sm text-gray-400">Monthly Added MRR</span>
                  <span className="font-bold text-white text-emerald-400">+${newMonthlyRevenue.toLocaleString()}</span>
                </div>
              </div>
            </div>

            <div className="mt-8 border-t border-white/10 pt-4">
              <div className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Total Lifetime Value Won</div>
              <div className="text-4xl font-black text-white mt-1 bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent">
      ...
      {/* ── Features ────────────────────────────────── */}
      <section id="features" className="relative bg-black/40 border-y border-white/5 py-24 overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black tracking-tight text-white">Centralize & Automate Everything</h2>
            <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">From the first ad click to the final membership signup, we handle the workflow.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={f.title} 
                className="p-8 rounded-3xl bg-white/[0.01] hover:bg-white/[0.03] border border-white/5 hover:border-violet-500/30 transition-all duration-300 group"
              >
                <div className={`h-14 w-14 rounded-2xl ${f.color} border flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-inner`}>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-8 py-28">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-white">Loved by Studio Owners</h2>
          <p className="text-gray-400 mt-2">See how our unified platform is shifting studio growth into high gear.</p>
        </div>
          ...
          {[
            ...
            <div key={idx} className="bg-white/[0.02] border border-white/5 rounded-2xl p-6 flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-300 italic text-sm leading-relaxed">"{t.quote}"</p>
              </div>
              <div className="mt-6 pt-4 border-t border-white/5">
                <div className="font-bold text-white text-sm">{t.author}</div>
                <div className="text-xs text-violet-400 mt-0.5">{t.role}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 lg:px-8 pb-28">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-gray-400">Everything you need to know about the platform and deployment.</p>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <div 
              key={idx} 
              className="bg-white/[0.02] border border-white/5 rounded-xl overflow-hidden transition-all hover:bg-white/[0.04]"
            >
              <button 
              ...
              >
                ...
                <ChevronDown className={`h-4 w-4 text-gray-400 transition-transform duration-300 ${openFaqIndex === idx ? 'rotate-180 text-violet-400' : ''}`} />
              </button>
              
              <div 
                className={`transition-all duration-300 ease-in-out overflow-hidden ${
                  openFaqIndex === idx ? 'max-h-48 border-t border-white/5 bg-white/[0.01]' : 'max-h-0'
                }`}
              >
                <p className="p-6 text-sm text-gray-400 leading-relaxed">{faq.a}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ── Premium CTA ─────────────────────────────── */}
      <section className="relative overflow-hidden bg-[#0A0712] border-t border-white/5 py-32 text-center">
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-transparent via-[#09070F] to-[#09070F]" />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <Link href="/pricing">
            <button className="inline-flex items-center gap-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white px-10 py-5 rounded-2xl text-lg font-bold transition-all shadow-2xl hover:shadow-violet-600/40 hover:-translate-y-1 hover:scale-[1.02]">
      ...
      {/* ── Footer ──────────────────────────────────── */}
      <footer className="bg-[#050409] text-gray-400 border-t border-white/5">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-12">
            ...
            <div className="max-w-xs">
              <div className="flex items-center gap-2.5 mb-6">
                ...
                <span className="text-xl font-black tracking-tight text-white">1herosocial.ai</span>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8">
                <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-violet-400 transition-colors">
                ...
                <a href="https://www.facebook.com/share/1DC9m6HpZ8/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-500 hover:text-violet-400 transition-colors">
                ...
                <a href="https://www.tiktok.com/@bft_tamanjurong?_r=1&_t=ZS-96tiNHuE5UC" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-500 hover:text-violet-400 transition-colors">
                ...
                <a href="#" aria-label="X (Twitter)" className="text-gray-500 hover:text-violet-400 transition-colors">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
              <div>
                ...
                <ul className="space-y-3 text-gray-500">
                  ...
                  <li><a href="#simulator" className="hover:text-violet-400 transition-colors">Lead Stream</a></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-gray-500">
                  ...
                  <li><Link href="/pricing" className="hover:text-violet-400 transition-colors">Register</Link></li>
                </ul>
              </div>
              <div>
