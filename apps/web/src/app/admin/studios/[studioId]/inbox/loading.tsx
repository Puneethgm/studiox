export default function InboxLoading() {
  return (
    <div className="space-y-4 animate-pulse">
      ...
      <div className="relative overflow-hidden rounded-[22px] border border-white/20 bg-white/20 px-5 py-3.5 backdrop-blur-2xl dark:border-white/5 dark:bg-neutral-900/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 h-[calc(100vh-210px)] min-h-[500px]">
        {/* Left side list pane */}
        <div className="lg:col-span-4 rounded-[24px] border border-white/20 bg-white/20 p-4 backdrop-blur-2xl dark:border-white/5 dark:bg-neutral-900/20 flex flex-col space-y-4 h-full">
        ...
        <div className="lg:col-span-8 rounded-[24px] border border-white/20 bg-white/20 p-5 backdrop-blur-2xl dark:border-white/5 dark:bg-neutral-900/20 flex flex-col h-full">
